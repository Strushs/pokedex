# Pokedex PWA - Zaliczenie na 5.0 🚀

Aplikacja typu Full-Stack pełniąca funkcję nowoczesnego katalogu Pokemonów. Stworzona na zaliczenie przedmiotu, zrealizowana zgodnie ze wszystkimi wymogami, na maksymalną ocenę **5.0**.

## 📌 Zrealizowane wymagania

### 🟢 3.0 oraz 3.5 z plusem - Zaawansowana Walidator Formularza
...
- Rejestracja trafia asynchronicznie przez żądanie typu `POST` poprzez funkcję Fetch, na własny, odseparowany **własny plik serwerowy/API** w folderze routes (`src/app/api/register/route.ts`). To nie jest środowisko symulowane w frontendzie!
- Skrypt w samym Node.js sprawdza przesłany JSON i od siebie wysyła flagę akceptacji.

---

## 🛠 Instalacja i uruchomienie (Dla Prowadzącego)
...
_(Zalecane testowaniem w przeglądarce Google Chrome w celu najlepszego wyświeltania interfejsu instalacji PWA)_.
